...
export const Hero = (props) => {
  return (
    <div className="hero-container" id="home">
      ...
      <div data-value="7" className="blob b13"></div>
      <div data-value="8" className="blob b14"></div>
      <div data-value="9" className="blob b15"></div>
      <div data-value="10" className="blob b16"></div>
      <div data-value="11" className="blob b17"></div>
      <div data-value="12" className="blob b18"></div>
      <div data-value="-7" className="blob b19"></div>
      <div data-value="-8" className="blob b20"></div>
